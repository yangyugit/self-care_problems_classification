...
def triplet_loss(y_true, y_pred, embedding_size = 90):
...
with open('neural_network_triplet_90_performance.pkl', 'wb') as file:
...
with open('neural_network_triplet_90_performance.pkl', 'rb') as file:
