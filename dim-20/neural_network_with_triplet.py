...
def triplet_loss(y_true, y_pred, embedding_size = 20):
...
with open('neural_network_triplet_20_performance.pkl', 'wb') as file:
...
with open('neural_network_triplet_20_performance.pkl', 'rb') as file:
