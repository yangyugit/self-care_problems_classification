...
def triplet_loss(y_true, y_pred, embedding_size = 125):
...
with open('neural_network_triplet_125_performance.pkl', 'wb') as file:
...
with open('neural_network_triplet_125_performance.pkl', 'rb') as file:
