...
def triplet_loss(y_true, y_pred, embedding_size = 40):
...
with open('neural_network_triplet_40_performance.pkl', 'wb') as file:
...
with open('neural_network_triplet_40_performance.pkl', 'rb') as file:
