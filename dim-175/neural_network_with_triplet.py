...
def triplet_loss(y_true, y_pred, embedding_size = 175):
...
with open('neural_network_triplet_175_performance.pkl', 'wb') as file:
...
with open('neural_network_triplet_175_performance.pkl', 'rb') as file:
