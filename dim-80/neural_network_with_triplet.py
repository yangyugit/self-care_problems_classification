...
def triplet_loss(y_true, y_pred, embedding_size = 80):
...
with open('neural_network_triplet_80_performance.pkl', 'wb') as file:
...
with open('neural_network_triplet_80_performance.pkl', 'rb') as file:
