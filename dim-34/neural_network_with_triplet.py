...
def triplet_loss(y_true, y_pred, embedding_size = 34):
...
with open('neural_network_triplet_34_performance.pkl', 'wb') as file:
...
with open('neural_network_triplet_34_performance.pkl', 'rb') as file:
