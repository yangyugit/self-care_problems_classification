...
def triplet_loss(y_true, y_pred, embedding_size = 50):
...
with open('neural_network_triplet_50_performance.pkl', 'wb') as file:
...
with open('neural_network_triplet_50_performance.pkl', 'rb') as file:
