...
print("test f2 std is: %f" %f1_std)

with open('neural_network_focal_performance.pkl_performance.pkl', 'wb') as file:
...
# with open('neural_network_focal_performance.pkl', 'rb') as file:
