...
def triplet_loss(y_true, y_pred, embedding_size = 30):
...
with open('neural_network_triplet_30_performance.pkl', 'wb') as file:
...
with open('neural_network_triplet_30_performance.pkl', 'rb') as file:
