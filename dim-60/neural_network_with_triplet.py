...
def triplet_loss(y_true, y_pred, embedding_size = 60):
...
with open('neural_network_triplet_60_performance.pkl', 'wb') as file:
...
with open('neural_network_triplet_60_performance.pkl', 'rb') as file:
